...
module.exports.eventSchema = yup.object().shape({
    ...
    reminderDate: yup.date().label('Reminder time').required().when('endDate', (endDate, yap) => endDate && yap.max(endDate, 'Reminder date cannot be after event end date')),
});
