export default {
    ...
    UNSELECT_CONTEST_TYPE: 'UNSELECT_CONTEST_TYPE',
    ...
    GET_USER_TRANSACTIONS_STATEMENT_REQUEST: 'GET_USER_TRANSACTIONS_STATEMENT_REQUEST',
    GET_USER_TRANSACTIONS_STATEMENT_SUCCESS: 'GET_USER_TRANSACTIONS_STATEMENT_SUCCESS',
    GET_USER_TRANSACTIONS_STATEMENT_ERROR: 'GET_USER_TRANSACTIONS_STATEMENT_ERROR',
    CLEAR_TRANSACTIONS_STORE_ERROR: 'CLEAR_TRANSACTIONS_STORE_ERROR',
    ...
    SET_STARTED_EVENT: 'SET_STARTED_EVENT',
    CLEAR_EVENTS_STORE_ERROR: 'CLEAR_EVENTS_STORE_ERROR',
    ...
    CONFIRM_RESETTING_PASSWORD_REQUEST: 'CONFIRM_RESETTING_PASSWORD_REQUEST',
    CONFIRM_RESETTING_PASSWORD_SUCCESS: 'CONFIRM_RESETTING_PASSWORD_SUCCESS',
    CONFIRM_RESETTING_PASSWORD_ERROR: 'CONFIRM_RESETTING_PASSWORD_ERROR',
    CLEAR_CONFIRM_RESETTING_PASSWORD_ERROR: 'CLEAR_CONFIRM_RESETTING_PASSWORD_ERROR',
    GET_CONTESTS_FOR_MODERATOR_REQUEST: 'GET_CONTESTS_FOR_MODERATOR_REQUEST',
    GET_CONTESTS_FOR_MODERATOR_SUCCESS: 'GET_CONTESTS_FOR_MODERATOR_SUCCESS',
    GET_CONTESTS_FOR_MODERATOR_ERROR: 'GET_CONTESTS_FOR_MODERATOR_ERROR',
    MODERATE_CONTEST_RESOLVE_REQUEST: 'MODERATE_CONTEST_RESOLVE_REQUEST',
    MODERATE_CONTEST_RESOLVE_SUCCESS: 'MODERATE_CONTEST_RESOLVE_SUCCESS',
    MODERATE_CONTEST_RESOLVE_ERROR: 'MODERATE_CONTEST_RESOLVE_ERROR',
    MODERATE_CONTEST_REJECT_REQUEST: 'MODERATE_CONTEST_REJECT_REQUEST',
    MODERATE_CONTEST_REJECT_SUCCESS: 'MODERATE_CONTEST_REJECT_SUCCESS',
    MODERATE_CONTEST_REJECT_ERROR: 'MODERATE_CONTEST_REJECT_ERROR',
    SET_NEW_CONTESTS_MODERATION_FILTER: 'SET_NEW_CONTESTS_MODERATION_FILTER',
    ...
    MODERATE_OFFER_RESOLVE_REQUEST: 'MODERATE_OFFER_RESOLVE_REQUEST',
    MODERATE_OFFER_RESOLVE_SUCCESS: 'MODERATE_OFFER_RESOLVE_SUCCESS',
    MODERATE_OFFER_RESOLVE_ERROR: 'MODERATE_OFFER_RESOLVE_ERROR',
    MODERATE_OFFER_REJECT_REQUEST: 'MODERATE_OFFER_REJECT_REQUEST',
    MODERATE_OFFER_REJECT_SUCCESS: 'MODERATE_OFFER_REJECT_SUCCESS',
    MODERATE_OFFER_REJECT_ERROR: 'MODERATE_OFFER_REJECT_ERROR',
    SET_NEW_OFFERS_MODERATION_FILTER: 'SET_NEW_OFFERS_MODERATION_FILTER',
